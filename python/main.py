...
parser.add_argument("--kepler2", type=str, default=None, choices=kepler2_reference_list, help="verify Kepler's 2nd law for a body. Reference body is chosen automatically based on selection of planet to evaluate for Kepler's second law. ")
...
if args.kepler2:
    ref = kepler2_reference_list[args.kepler2]
